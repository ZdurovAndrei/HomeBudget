...
public class ActivityCosts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        editTextCostsDate = (EditText) findViewById(R.id.editTextCostsDate);
        editTextCosts = (EditText) findViewById(R.id.editTextCosts);
        editTextCostsInfo = (EditText) findViewById(R.id.editTextCostsInfo);
